...
![Azure Firewall DNAT rule configuration showing traffic routing from the firewall public IP to private NGINX web server at 10.1.1.4 in the spoke network, displaying successful NAT translation settings in the Azure portal](./dnat-nginx.png)
